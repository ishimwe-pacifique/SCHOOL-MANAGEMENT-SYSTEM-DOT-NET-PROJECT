...
{
    private readonly string connectionString = "Data Source=DESKTOP-BUVN895;Initial Catalog=SchoolSysDB-2;Integrated Security=True;Encrypt=True;TrustServerCertificate=True";
    ...
    public IActionResult OnPost()
    {
        ...
        // Load saved marks for this class
    ...
    private void LoadDropdowns()
    {
        ...
        using (SqlConnection conn = new SqlConnection(connectionString))
        {
            ...
            // Load classes
            var classCmd = new SqlCommand("SELECT ClassId, ClassName FROM Classes", conn);
            ...
            while (classReader.Read())
            {
                ClassOptions.Add(new SelectListItem
                {
                    ...
                    Text = classReader["ClassName"].ToString()
                });
            }
            classReader.Close();
